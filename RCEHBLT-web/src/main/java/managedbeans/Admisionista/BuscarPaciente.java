...
public class BuscarPaciente {
    ...
    private List<ConsentimientoInformado> filtrarConsentimientoInt(List<ConsentimientoInformado> consentimientosAuxInt, int idPaciente) {        
        ...
        for (int i = consentimientosAuxInt.size() - 1; i >= 0; i--) {      
            if (consentimientosAuxInt.get(i).getPacIdPersona().getIdPersona() != idPaciente  ) {                
...
//        }
        for (int i = consentimientosAux.size() - 1; i >= 0; i--) {
            ...
            if (consentimientosAux.get(i).getPacIdPersona().getIdPersona() != idPaciente  ) {                
...
//        }
    ...
    public void setPersonaSeleccionada(Persona personaSeleccionada) {
        ...
        consentimientosSeleccionadosEst = filtrarConsentimientoEst(consentimientos, pacienteSeleccionado.getIdPersona());
        consentimientos = consentimientoInformadoFacade.findAll();
        consentimientosSeleccionadosInter = filtrarConsentimientoInt(consentimientos, pacienteSeleccionado.getIdPersona());
    }
