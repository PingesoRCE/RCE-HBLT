...
//                personaFacade.edit(persona);
        ...
        //if (persona.getPersRut() == 0) {
            ...
            if (medicoReferenciaId != 0) {
                medicoReferenciaId = profesionalNegocio.busquedaProfesionalIdPersona(medicoReferenciaId).getIdPersona();            
                profesional.setProIdPersona(new Profesional(medicoReferenciaId));
            }
            ...
            if (fechaDesde != null && fechaHasta != null) {
                ...
                if (fechaDesde.before(fechaHasta)) {
                    ...
                    profesional.setIdPersona(persona.getIdPersona());
    ...
    public void buscar(ActionEvent actionEvent) {
        ...
        if (personaNegocio.busquedaPersonaRut(rut).size() > 0) {
            ...
            if (profesional != null) {
                ...
                if (profesional.getProIdPersona() != null) {
                    
                    this.medicoReferenciaId = profesional.getProIdPersona().getPersona().getIdPersona();
                }
    ...
    public List<String> completarRut(String query) {
        ...
        for (Profesional profesional1 : listaProfesionales) {
            ...
            if (profesional1.getPersona().getPersRut().toString().startsWith(query) && !listaFiltrada.contains(profesional1.getPersona().getPersRut().toString())) {
                String temp = profesional1.getPersona().getPersRut().toString().concat(profesional1.getPersona().getPersDv());
