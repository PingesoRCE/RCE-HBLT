...
public class ConsentimientoInformado implements Serializable {
    ...
    @ManyToOne
    private Profesional idPersona;
    @JoinColumn(name = "pac_id_persona", referencedColumnName = "id_persona")
    @ManyToOne
    private Paciente pacIdPersona;
    ...
    public Profesional getIdPersona() {
        return idPersona;
    }

    public void setIdPersona(Profesional idPersona) {
        this.idPersona = idPersona;
    }

    public Paciente getPacIdPersona() {
        return pacIdPersona;
    }

    public void setPacIdPersona(Paciente pacIdPersona) {
    ...
    public String toString() {
        return "cl.rcehblt.ConsentimientoInformado[ idConsentimiento=" + idConsentimiento + " ]";
    }
