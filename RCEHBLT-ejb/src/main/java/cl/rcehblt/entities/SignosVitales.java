...
@NamedQueries({
    ...
    @NamedQuery(name = "SignosVitales.findByUnidad", query = "SELECT s FROM SignosVitales s WHERE s.unidad = :unidad")})
public class SignosVitales implements Serializable {
    ...
    private List<Muesta> muestaList;
    ...
    @XmlTransient
    public List<Muesta> getMuestaList() {
        return muestaList;
    }

    public void setMuestaList(List<Muesta> muestaList) {
        this.muestaList = muestaList;
    }
    ...
    public String toString() {
        return "cl.rcehblt.SignosVitales[ idSvitales=" + idSvitales + " ]";
    }
