...
public class Log implements Serializable {
    ...
    private List<DetalleLog> detalleLogList;
    ...
    @XmlTransient
    public List<DetalleLog> getDetalleLogList() {
        return detalleLogList;
    }

    public void setDetalleLogList(List<DetalleLog> detalleLogList) {
        this.detalleLogList = detalleLogList;
    }
    ...
    public String toString() {
        return "cl.rcehblt.Log[ idLog=" + idLog + " ]";
    }
